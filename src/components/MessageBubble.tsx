...
export const MessageBubble = React.memo(function MessageBubble({ message, onRegenerate, isLast, isGenerating, onSaveAsset, onEdit }: MessageBubbleProps) {
        ...
        <div className={cn("flex-1 min-w-0 flex flex-col", isUser ? "items-end" : "items-start")}>
          ...
          {message.thinking && (
            ...
            >
              ...
              <div ref={thinkingRef} className="mt-2 whitespace-pre-wrap break-words max-h-[400px] overflow-y-auto scrollbar-thin">
                {message.thinking}
              </div>
            </details>
          )}
